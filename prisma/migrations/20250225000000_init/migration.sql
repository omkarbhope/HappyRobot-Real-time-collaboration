...
-- CreateIndex
CREATE INDEX "BoardEvent_boardId_seq_idx" ON "BoardEvent"("boardId", "seq");

-- CreateIndex
CREATE UNIQUE INDEX "BoardEvent_boardId_seq_key" ON "BoardEvent"("boardId", "seq");
...
-- AddForeignKey
ALTER TABLE "BoardEvent" ADD CONSTRAINT "BoardEvent_boardId_fkey" FOREIGN KEY ("boardId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;
